...
HD_PWD='D:/CircuitProjects/Xilinx/FinalProject/FinalProject.runs/design_1_buttonCtrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_buttonCtrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_buttonCtrl_0_0.tcl
